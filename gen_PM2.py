...
def target_rotate(ftimg,rotate,scale,pts):
    ...
    dst = cv.warpAffine(ftimg, matRotate, (w, h))
    pts_t=[]
    for point in pts:
...
def save_label_info(img,name,dir_label,dir_info,dir_vis, shape_):
    label_name_to_value = {'_background_': 0, "good": 1 , "defect_1":2, "defect_2":3}
...
if __name__ == '__main__':
    ...
    label_name = ["good", "defect_1", "defect_2"]
    ...
    pts1 = [[782, 1328], [1095, 1283], [1492, 1238], [1912, 1202], [2292, 1167], [2628, 1147], [2876, 1131], [2953, 1147], [2957, 1193], [2957, 1234], [2931, 1267], [2915, 1296], [2924, 1512], [2960, 1528], [2976, 1554], [2963, 1615], [2889, 1644], [2537, 1647], [1828, 1647], [1276, 1615], [763, 1593], [715, 1589], [695, 1515], [695, 1428], [715, 1347]]  #target在原图片中的轮廓点
    pts2=[[782, 1328], [1095, 1283], [1492, 1238], [1912, 1202], [2292, 1167], [2628, 1147], [2876, 1131], [2953, 1147], [2957, 1193], [2957, 1234], [2931, 1267], [2915, 1296], [2924, 1512], [2960, 1528], [2976, 1554], [2963, 1615], [2889, 1644], [2537, 1647], [1828, 1647], [1276, 1615], [763, 1593], [715, 1589], [695, 1515], [695, 1428], [715, 1347]]
    pts3=[[782, 1328], [1095, 1283], [1492, 1238], [1912, 1202], [2292, 1167], [2628, 1147], [2876, 1131], [2953, 1147], [2957, 1193], [2957, 1234], [2931, 1267], [2915, 1296], [2924, 1512], [2960, 1528], [2976, 1554], [2963, 1615], [2889, 1644], [2537, 1647], [1828, 1647], [1276, 1615], [763, 1593], [715, 1589], [695, 1515], [695, 1428], [715, 1347]]
    ...
    for i in tqdm(range(300)):#生成图片(生成失败的跳过)
        ...
        for j in range(ran_tar_nums):
            ...
            #     print(i,j)
            bgimg,dst=Gen_Cheese_Datas(bgimg,frontimgs[ran_id],pts[ran_id],(ran_x,ran_y),ran_rotate,0.5)    #生成合成图片
            shape = {}
            if dst!=None:
